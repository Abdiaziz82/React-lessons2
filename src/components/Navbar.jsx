  ...
  return (
    <div>
      ...
      <div class='flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full'>
        <a href="javascript:void(0)" class="max-sm:hidden"><img src={logo} alt="logo" class='w-[54px]' />
        </a>
        <a href="javascript:void(0)" class="hidden max-sm:block"><img src={logo} alt="logo" class='w-8' />
        </a>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink to = "/table"
              class='font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]'>Team</NavLink>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink to="/products"
              class='font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]'>Products</NavLink>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink to="/posts"
              class='font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]'>Blog</NavLink>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'><NavLink to ="/about"
        ...
        <div class='flex gap-4 ml-auto'>
          ...
          <button class="font-medium text-[15px] border-0 outline-0 cursor-pointer"><NavLink to = "/login"
            class="text-blue-700 hover:underline">Login</NavLink></button>
          <NavLink to ="/signup">
            <button
            class="px-4 py-2 text-sm rounded-xs font-medium text-white border border-blue-600 bg-blue-600 hover:bg-blue-700 cursor-pointer whitespace-nowrap">Sign
            up</button>
            </NavLink>
